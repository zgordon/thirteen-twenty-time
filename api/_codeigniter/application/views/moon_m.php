<html>
	<head>
		...
		<style>
			body {font-family: Helvetica, Arial, san-serif; background: transparent}
			#wrapper {width: 100%; margin: 0 auto;}
			h1 {font-size: 14px; font-weight: normal; text-align: center; margin: 2px 0}
			table {background: transparent}
			tr {display: block; float: left; clear: both; border-radius: 10px; -moz-border-radius: 10px; margin: 2px 0; padding: 0 5px }			
			th {font-weight: normal; padding: 0 6px; margin: 0;border: 1px #fff solid; font-size: 13px}
			td {float: left; clear: none;position: relative; border: 1px #ccc solid; margin: 3px; border-radius: 10px; -moz-border-radius: 10px; background: #fff}
			td:hover, td:active { border-color: #888}
			th img {display: block; margin: 5px auto; width: 23px;}			
			td img {display: block; width: 25px; }
			...
			td span.day {display: block; color: #999; font-size: 9px; position: absolute; background: white; top: -1px; left: -1px}
			td.active span.day {color: #222}
			td span.gregorian {display: none; clear: both; text-align: center; font-size: 11px; padding: 3px 0 2px; margin-bottom: 0; }
...
*/
	...
	<body>
	<div id="wrapper">
	<h1><?php print $moon->name; ?> Moon</h1>
	<table>
	<thead>
		<tr>
			<th>
